...
type ProductsLikeButtonProps = IProduct;

const ProductsLikeButton: React.FC<ProductsLikeButtonProps> = (product) => {
    ...
    return (
        <LikeButton onClick={handleFavouriteClick} isLiked={Boolean(fav)} disabled={isSubmitting} />
    )
}

export default ProductsLikeButton;