...
const Square: React.FC<SquareProps> = ({ squareMin, squareMax }) => {
    ...
    const { run: debounceMinSquare } = useDebounceFn(hangleMinValueChange, { wait: 300 });
    ...
    const { run: debounceMaxSquare } = useDebounceFn(hangleMaxValueChange, { wait: 300 });
            ...
            <div className="square__wrapper">
                <label className="square__range">
                    ...
                    <NumericInput
                        ...
                        allowNegative={false}
                        value={minValue}
                        onChange={(event) => debounceMinSquare(event.target.value)}
                ...
                <label className="square__range">
                    ...
                    <NumericInput
                        ...
                        allowNegative={false}
                        value={maxValue}
                        onChange={(event) => debounceMaxSquare(event.target.value)}
